...
fn test_voyage_nano() -> Result<()> {
    ...
    insta::assert_yaml_snapshot!("voyage_nano_cpu_batch", embeddings_batch, &matcher);
    ...
    insta::assert_yaml_snapshot!("voyage_nano_cpu_single", embeddings_single, &matcher);
