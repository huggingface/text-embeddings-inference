...
fn test_static_embedding() -> Result<()> {
    ...
    insta::assert_yaml_snapshot!("static_embedding_batch", embeddings_batch, &matcher);
    ...
    insta::assert_yaml_snapshot!("static_embedding_single", embeddings_single, &matcher);
...
fn test_static_embedding_pooled_raw() -> Result<()> {
    ...
    insta::assert_yaml_snapshot!("static_embedding_single_raw", embeddings_single, &matcher);
