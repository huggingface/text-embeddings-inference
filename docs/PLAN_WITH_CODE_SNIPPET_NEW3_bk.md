...
## Milestone 1: Model Detection & CLI
...
**File:** `router/src/strategy.rs` (NEW FILE)
...
**Location:** Add ModelKind enum for detection
...
**File:** `core/src/detection.rs` (NEW - Shared detection logic)
...
**File:** `router/src/lib.rs`
**Location:** Add new struct for listwise configuration
